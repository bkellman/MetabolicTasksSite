...
@section('content')
<div class='median-6 columns'>
	<ol>
	<li><a href="#overview">Computation framework of the metabolic tasks</a></li>
	<li><a href="#threshold">Threshold definition</a></li>
	<li><a href="#models">List of available genome-scale models</a></li>
	<li><a href="#tasks">Curation of metabolic tasks</a></li>
	</ol>

</div>

<div class="medium-9 columns">
	<h1 id="overview">1. Computation framework of the metabolic tasks</h1>
		<p>
		...
		<br><br>
		Finally, the metabolic score can be compute as the mean of the product of the activity level of each reaction with the significance of its associated gene:<br>
...
<h1 id="threshold">2. Threshold definition</h1>
We propose two approaches to describe the scheme of threshold imposition on expression value for gene and/or reaction to be considered as “active”. 
	...
	<ol>
		<li><b>Global</b> approach, the threshold value is the same for all the genes. The global approach is mainly applied when only one sample is available (i.e. sample could be associated to a condition, a cell-type or a tissue) and/or no information is available in the literature to define expression threshold for a single gene. The user can define the global threshold using a value or a percentile:
			<ul>
		...
		<li><b>Local</b> approach, the threshold value is different for all the genes. The local approach is often applied when multiple samples are available as it allows having a relative assessment of the activity of a gene across samples. Multiple options are available to compute the local thresholds:
			<ul>
...
<h1 id="models">List of available genome-scale models</h1>

<h3>Human models</h3>
	<ul>
		<li>Recon 2.2 - Swainston, N. et al. (2016) Recon 2.2: from reconstruction to model of human metabolism. Metabolomics, 12, 109.</li>
		<li>Recon2 - Thiele, I. et al, (2013) A community-driven global reconstruction of human metabolism. Nature Biotechnology, 31, 419-425.</li>
		<li>Recon 1 - Duarte et al. (2007) Global reconstruction of the human metabolic network based on genomic and bibliomic data. Proceedings of the National Academy of Sciences, 104(6):1777-1782.</li>
		<li>quek14:Quek et al (2014). Reducing Recon 2 for steady-state flux analysis of HEK cell culture. Journal of Biotechnology, 184:172-178</li>
		<li>iHsa : Blais et al. (2017) Reconciled rat and human metabolic networks for comparative toxigenomics and biomarker predictions. Nature Communications, 8:14250</li>
	</ul>
<h3>Rat models</h3>
<ul>
<li>iRno : Blais et al. (2017) Reconciled rat and human metabolic networks for comparative toxigenomics and biomarker predictions. Nature Communications, 8:14250</li>
</ul>
<h3>Mouse models</h3>
<ul>
<li>iMM1415 : Sigurdsson et al. (2010) A detailed genome-wide reconstruction of mouse metabolism based on human Recon1. BMC Systems Biology, 4:140.</li>
</ul>

<h3>CHO models</h3>
<ul>
<li>iCHOv : Hefzi et al. (2016) A consensus Genome-scale reconstruction of Chinese Hamster Ovary cell metabolism. Cell Systems, 3(5):434-443.</li>
</ul>

<h1 id="tasks">Curation of metabolic tasks</h1>
