@php
	...
	$description = 
			"<ul>
				<li>Drag and drop plain text (.txt) file with two columns</li>
				<ul>
					<li>Column1: entrez gene IDs for the selected organism</li>
					<li>Column2: normalized expression values</li>
				</ul>
				...
				<li>Disable adblocking software if the upload does not work</li>  
...
<script>
	...
	// ADD CHECK AGAINST REFERENCE HERE (ASK TYLER)
